...
async def test_graph_structure():
    ...
    with patch(
        ...
        assert "synthesizer_node" in app.nodes

        # Check subagent nodes
        assert "business_process_analyst" in app.nodes
        assert "workflow_analyst" in app.nodes
        assert "report_analyst" in app.nodes
        assert "system_specialist" in app.nodes
        assert "transaction_specialist" in app.nodes
