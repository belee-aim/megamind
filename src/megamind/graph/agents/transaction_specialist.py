...
async def transaction_specialist(state: AgentState, config: RunnableConfig):
    """
    Transaction Specialist subagent.
    Specializes in complex transactions like reconciliation and stock entries.
    """
    logger.debug("---TRANSACTION SPECIALIST---")
    ...
    prompt = TRANSACTION_SPECIALIST_PROMPT + task_context
